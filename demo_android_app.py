...
st.markdown("<p style='text-align:center; color:#666;'>Um aplicativo educacional que une tecnologia e aprendizado de máquina para ensinar finanças de forma prática e interativa.</p>", unsafe_allow_html=True)
